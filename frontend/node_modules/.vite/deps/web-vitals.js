...
var u = "function" == typeof WeakSet ? /* @__PURE__ */ new WeakSet() : /* @__PURE__ */ new Set();
var f = function(e2, t2, n2) {
  var i2;
  return function() {
    t2.value >= 0 && (n2 || u.has(t2) || "hidden" === document.visibilityState) && (t2.delta = t2.value - (i2 || 0), (t2.delta || void 0 === i2) && (i2 = t2.value, e2(t2)));
  };
};
...
var l = function(e2, t2) {
  var n2, i2 = d(), o2 = a("FCP"), s2 = function(e3) {
    "first-contentful-paint" === e3.name && (p2 && p2.disconnect(), e3.startTime < i2.timeStamp && (o2.value = e3.startTime, o2.entries.push(e3), u.add(o2), n2()));
...
var y = function(i2, a2) {
  e || (e = a2, t = i2, n = /* @__PURE__ */ new Date(), w(removeEventListener), g());
};
var g = function() {
  if (t >= 0 && t < n - S) {
